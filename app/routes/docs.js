...
router.post(
  ...
  authService.authorize,
  multerStart(fieldsFile),
  controller.createChefLicense
);
router.post(
  "/chefCertificate",
  authService.authorize,
  multerStart(fieldsFile),
  controller.createChefCertificate
);
router.post(
  "/kitchenPhoto",
  authService.authorize,
  multerStart(fieldsFile),
  controller.createKitchenPhoto
);
router.post(
  "/nidFrontSide",
  authService.authorize,
  multerStart(fieldsFile),
  controller.createNIDFrontInside
);
router.post(
  "/profilePhoto",
  authService.authorize,
  multerStart(fieldsFile),
  controller.createProfilePhoto
);
router.post(
  "/socialSecurityNumber",
  authService.authorize,
  multerStart(fieldsFile),
  controller.insertSocialSecurityNumber
);
router.post(
  "/driverLicense",
  authService.authorize,
...
router.post(
  ...
  authService.authorize,
  multerStart(fieldsFile),
  controller.createDriverVehicleLicense
);
