...
router.put(
	...
	controller.userCancelOrderItem
);
...
router.get(
	...
	userController.getAuthUserMiddleware,
	middlewares.userRoleRequired,
	controller.userOrderItemDeliveries
);
...
router.get(
	...
	userController.getAuthUserMiddleware,
	middlewares.chefRoleRequired,
	controller.chefOrderItemDeliveries
);
