...
router.get('/', authService.authorize, userController.getAuthUserMiddleware, controller.getNotifications);
router.put('/', authService.authorize, userController.getAuthUserMiddleware, controller.updateNotificationState);
