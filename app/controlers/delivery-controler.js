...
exports.calculateDeliveryTime = async (req, res, next) => {
	let origins = req.body.origins ? req.body.origins.split() : null;
	let destinations = req.body.destinations
		? req.body.destinations.split()
		: null;
...
exports.editStateType = (message) =>
	asyncHandler(async (req, res, next) => {
		...
		const chefOrderDelivery = await orderDeliveryRepository.getDeliveryChefDetails(
			req.orderDelivery.id
		);
